...
const Home: NextPage = () => (
	<div className="content-container mb-4">
		...
		<p className="md:max-w-lg mx-6">
			In our fourth season as a team, we&apos;re returning to in-person meets and competition
		...
		<Link href={`/seasons/${new Date().getFullYear()}/members`}>
			<a className="button">Meet our 2021 team</a>
		</Link>
		<br />
		...
		<br />
		<p>
			<a className="button" href="https://robotx.smugmug.com/">
